                        ...
                        <div class="c-categoryProducts-changer">
                            ...
                            <div class="c-categoryProducts-changer-buttons-container">
                                <div  class="c-categoryProducts-changer-buttons">
                                    <button title="Widok kafelków" class="button-tiles" id="js-button-tiles"  <?php if(isset($_COOKIE['widok'])){if($_COOKIE['widok']=="tiles")print ('disabled');}else print ('disabled');?> ><span class="c-categoryProducts-changer-buttons-tiles"><svg style="width: 100%;height: 100%;" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                                                <g>
