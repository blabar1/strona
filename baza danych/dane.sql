...
Obudowa głośnika Google Home została wyposażona w panel dotykowy, dzięki któremu będziesz go mógł kontrolować.", "p37.jpg", 21),
("TP-Link Tapo C200 2Mpx 1080P LED IR (dzień/noc) obrotowa", 129, 20, "Obrotowa kamera Wi-Fi do monitoringu domowego, Tapo C200 zapewnia zdumiewającą jakość wideo. Obraz w rozdzielczości 1080P sprawi, że wszystkie twoje nagrania będą niezwykle wyraźne. Co więcej, kamera wykryje podejrzany ruch, nawet w nocy i natychmiast dostaniesz powiadomienie. Włącz alarm, a z łatwością odstraszysz nieproszonych gości. Natomiast wbudowany mikrofon i głośnik umożliwią skuteczną komunikację.", "p38.jpg", 21),
("Belkin SoundForm Elite Czarny (AirPlay)", 699, 34, "Mocny i krystalicznie czysty dźwięk zapewniający doskonałe doznania z inteligentnym głośnikiem Belkin SoundForm Elite. Firma Belkin nawiązała współpracę z ekspertami w dziedzinie Hi-Fi z firmy Devialet, aby połączyć niezwykłą technologię dźwięku z wielokrotnie nagradzanym wzornictwem i funkcją ładowania bezprzewodowego. Korzystaj z AirPlay aby odtwarzać muzykę i uzyskać oszałamiający dźwięk, który wypełni każde pomieszczenie w domu.", "p39.jpg", 21),
...
Urządzenie pozwala dokonywać prawidłowych pomiarów ciśnienia tętniczego i pulsu. Po zakończeniu pomiaru otrzymasz natychmiast wyniki oznaczone kolorami na wyświetlaczu monitora BPM Connect oraz w aplikacji. Wyniki możesz w łatwy sposób udostępnić swojemu lekarzowi.", "p40.jpg", 22),
...
Oferowany nadajnik jest przewidziany dla osób noszących rozmiary w przedziale M-XXL.", "p41.jpg", 22),
("Silver Monkey Kabel HDMI 2.0 - HDMI 1,5m", 16.99, 11, "Wybierz kabel HDMI marki Silver Monkey i wykorzystaj pełen potencjał obrazu w 4K. To wysokiej jakości akcesorium ma 1,5 metra długości oraz solidne wtyczki z pozłacanymi końcówkami. Kabel HDMI-HDMI Silver Monkey wspiera ponadto standard HDMI 2.0, transmitując obraz i dźwięk w doskonałej jakości. Co więcej, współpracuje z telewizorami, monitorami, laptopami, odtwarzaczami Blu-Ray, jak i konsolami wideo. Otwórz się na nowe doznania wizualne.", "p42.jpg", 23),
...
Pozłacane wtyki z aluminiowym wykończeniem oraz w 100% miedziany rdzeń, z dołączoną ochroną przed zakłóceniami EMI czy RFI, zapewniają przesyłanie stabilnego sygnału pomiędzy wszystkimi kompatybilnymi urządzeniami.", "p44.jpg", 23),
...
Urządzenie wykonano z wysokiej jakości materiałów, dzięki czemu możesz liczyć na jego niezawodność, a pozłacane styki zagwarantują przesyłanie obrazu bez żadnych zakłóceń.", "p45.jpg", 24),

("Unitek Adapter USB-A - USB-C 3.1 Gen1", 24.99, 56, "Adapter Unitek USB-A - USB-C 3.1 ma obudowę wykonaną z trwałego stopu cynku, dzięki czemu jest niezwykle trwały i wytrzymały. Dodatkowo ma kompaktowe rozmiary i specjalny otwór, dzięki czemu łatwo przymocujesz go np. do kluczy czy torby.", "p46.jpg", 24),
("Intel Core i9-12900K", 2999, 15, "Poznaj procesory Intel Core dwunastej generacji do komputerów stacjonarnych, stworzone do gamingu nowej generacji. Bezkompromisowe granie i wielozadaniowość umożliwia hybrydowa i bardziej wydajna architektura odblokowanego procesora Intel Core i9-12900K, korzystająca z dwóch rodzajów rdzeni: 8 wysoko wydajnych (Performance Core) i 8 energooszczędnych (Efficient Core).", "p47.jpg", 15);
