...
<head>
    ...
    <!-- menu,header-->
    <div class="c-header">
        <div class="o-wrap-relative">
            <div class="c-header__wrapper">
                <div class="cd-morph-dropdown"><a href="#0" class="nav-trigger" id="not active"><span aria-hidden="true"></span></a>
                    <div class="o-wrapper__menu__hidding">
                        <a href="index.html"><img class="c-menu c-logo" src="" alt="ikona_sklepu" /></a>
                        <ul class="c-menu">
                                    ...
                                    <ul>
                                        <li class="has-dropdown gallery" data-content="about">
                                            <a href="#0">
                                                <div class="svg-photo-wrap">
                                                    <div class="svg-photo"><svg style="width: 100%;height: 100%;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                        ...
                                        <li class="has-dropdown gallery" data-content="about">
                                            <a href="#0">
                                                ...
                                                <div class="has-dropdown-title">Akcesoria</div>
                                            </a>
                                        </li>
